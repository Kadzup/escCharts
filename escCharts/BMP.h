    ...
    public:
        ...
        BMP(int32_t width, int32_t height, bool has_alpha = true) {
            ...
            if (has_alpha) {
                ...
                fileHeader.file_size = fileHeader.offset_data + static_cast<uint32_t>(data.size()) + bmpInfoHeader.height * (newStride - rowStride);
            }
        }
        ...
        void DrawRectangle(uint32_t x0, uint32_t y0, uint32_t w, uint32_t h,
